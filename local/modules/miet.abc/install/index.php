...
Битрикс CModule*/
Class miet_abc extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "miet.abc";
    var $MODULE_ID = "miet.abc";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("miet.abc_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("miet.abc_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("miet.abc_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("miet.abc_PARTNER_URI");
    }
